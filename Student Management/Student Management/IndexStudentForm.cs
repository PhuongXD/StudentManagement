...
namespace Student_Management
{
    ...
    public partial class IndexStudentForm : Form
    {
        ...
        {
            var @students = (PM13997)this.grdStudents.SelectedRows[0].DataBoundItem;
            var updateForm = new UpdateStudentForm(@students.id);
        ...
        void btnDelete_Click(object sender, EventArgs e)
        {
            if(this.grdStudents.SelectedRows.Count==1)
           {
               ...
               {
                   var @student = (PM13997)this.grdStudents.SelectedRows[0].DataBoundItem;
        ...
        {
            var student = this.Business.GetStudents();
